...
const Projects = () => {
  ...
  return (
    <>
      ...
      <ProjectTemplate myProject={project3} isFlipped={false}>
        <ControllerSpline />
      </ProjectTemplate>
